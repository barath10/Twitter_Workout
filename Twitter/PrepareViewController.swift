...
class PrepareViewController: UIViewController {
    ...
    @objc func navigateToHomeAfterLoggedIn(notification: Notification){
    ...
    @objc func failedToLogin(notification: Notification){
    ...
    @objc func statusBarShouldUpdate(notification: Notification){
