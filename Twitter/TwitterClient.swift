...
class TwitterClient: NSObject{
    ...
    static let oAuthURLScheme = "bharathTwitter"
    static let oAuthURLHost = "oauth"
    static let oAuthBaseURL = "https://api.twitter.com"
    static let consumerKey = "dOC6OQx4pL7lYRgkN50iYYNuA"
    static let consumerSecret = "7rccWJI3ZnZMO4eQmyE0RAAs2eub9h2vLXTKq5jXaUamoHej0I"
