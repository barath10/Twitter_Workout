...
class TweetTableViewCell: UITableViewCell {
    ...
    @objc func favorStackViewTapped(_ gesture: UITapGestureRecognizer){
    ...
    @objc func retweetStackViewTapped(_ gesture: UITapGestureRecognizer){
    ...
    @objc func mediaTaped(_ gesture: UITapGestureRecognizer){
        if let delegate = delegate{
            delegate.mediaImageViewTapped(cell: self, image: self.mediaPhotoImageView.image, tweet: self.tweet)
        }
    }
    
    @objc func userProfileTapped(_ gesture: UITapGestureRecognizer){
        if let delegate = delegate{
